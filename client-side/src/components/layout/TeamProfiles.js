                    ...
                    <div className="row gy-4 gy-lg-0">
                        <div className="col-12 col-lg-3">
                            <div className="card border-0">
                                ...
                                <div className="card-body border bg-white p-4">
                                    <h2 className="card-title h5 fw-bold mb-3">Oluwafemi Awodele</h2>
                                    <p className="card-text text-secondary">Designs and develops the backend infrastructure of VestoBlog, including databases, APIs, and server-side logic.</p>
                                </div>
                        ...
                        <div className="col-12 col-lg-3">
                            <div className="card border-0">
                                ...
                                <div className="card-body border bg-white p-4">
                                    <h2 className="card-title h5 fw-bold mb-3">Michael Kazembe</h2>
                                    <p className="card-text text-secondary"> Designs and implements user interfaces for VestoBlog, ensuring they are visually appealing, user-friendly, and responsive.</p>
                                </div>
                                <div className="card-footer border border-top-0 bg-white p-4">
                                    <ul className="nav mb-0 bsb-nav-sep">
                                        <li className="nav-item text-secondary">
                        ...
                        <div className="col-12 col-lg-3">
                            <div className="card border-0">
                                ...
                                <div className="card-body border bg-white p-4">
                                    <h2 className="card-title h5 fw-bold mb-3">Nnena Kehinde</h2>
                                    <p className="card-text text-secondary">Implements backend features such as user authentication, and data storage, ensuring scalability and security.</p>
                                </div>
                                <div className="card-footer border border-top-0 bg-white p-4">
                                    <ul className="nav mb-0 bsb-nav-sep">
                                        <li className="nav-item text-secondary">
                        ...
                        <div className="col-12 col-lg-3">
                            <div className="card border-0">
                                ...
                                <div className="card-body border bg-white p-4">
                                    <h2 className="card-title h5 fw-bold mb-3">Kennedy Onyekachi</h2>
                                    <p className="card-text text-secondary">Translates design mockups and user stories into interactive web pages, focusing on optimization and performance.</p>
                                </div>
                                <div className="card-footer border border-top-0 bg-white p-4">
                                    <ul className="nav mb-0 bsb-nav-sep">
                                        <li className="nav-item text-secondary">
